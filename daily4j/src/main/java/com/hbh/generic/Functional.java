...
public class Functional {
	...
	public static <R, T> List<R> transfrom(Iterable<T> seq, UnaryFunction<R, T> func) {
		List<R> result = new ArrayList<R>();
		for(T t : seq) {
			result.add(func.fucntion(t));
		}
		return result;
	}
	...
	static class BigDecimalUlp implements UnaryFunction<BigDecimal, BigDecimal> {
		...
		@Override
		public BigDecimal fucntion(BigDecimal x) {
			return x.ulp();
		}
	...
	static class MultiplyingIntegerCollector implements Collector<Integer> {
		...
		@Override
		public Integer fucntion(Integer x) {
			val *= x;
			return val;
		}
